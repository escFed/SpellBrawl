...
public class CardAnimationsUI : MonoBehaviour
{
    ...
    public void OnCardInteraction(int cardIndex)
    {
        ...
        LeanTween.moveY(cardTransform, originalPos.y + 200f, 0.15f)
                 .setEase(LeanTweenType.easeOutQuad)
                 .setOnComplete(() =>
                 {
                     LeanTween.moveY(cardTransform, originalPos.y, 0.15f)
                              .setEase(LeanTweenType.easeInQuad);
                 });
    }

    private void ResetCardPositions(int playerIndex, ICardable[] hand)
    {
